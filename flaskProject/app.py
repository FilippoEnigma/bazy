...
def register():
    if request.method == 'POST':
        ...
        if not (imie and nazwisko and email and haslo and rola):
            flash("Wszystkie pola są wymagane", 'danger')
        else:
            execute_stored_procedure('AddUser', (imie, nazwisko, email, haslo, rola))
    ...
    if request.method == 'POST':
        ...
        if action == 'add':
            ...
            if not (nazwa and data and miejsce_id and opis and limit_miejsc and cena):
                ...
                execute_stored_procedure('AddEvent', (nazwa, data, miejsce_id, opis, limit_miejsc, cena))
